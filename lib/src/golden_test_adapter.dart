...
GoldenFileExpectation defaultGoldenFileExpectation = (Object a, Object b) => () => expectLater(a, matchesGoldenFile(b));
...
set goldenFileExpectationFn(GoldenFileExpectation value) => _goldenFileExpectationFn = value;
...
BlockedTextPaintingContextBuilder _paintingContextBuilder = defaultPaintingContextBuilder;

/// A function to be used as the [BlockedTextPaintingContextBuilder] for drawing
/// blocked text.
BlockedTextPaintingContextBuilder get paintingContextBuilder => _paintingContextBuilder;

set paintingContextBuilder(BlockedTextPaintingContextBuilder value) => _paintingContextBuilder = value;
...
class FlutterGoldenTestWrapper extends StatelessWidget {
  ...
  /// The theme provided by the global [AurumConfig], if any.
  ///
  ...
  ThemeData _resolveThemeOf(BuildContext context) {
    final hasInheritedTheme = context.findAncestorWidgetOfExactType<Theme>() != null;
    final inheritedTheme = hasInheritedTheme ? Theme.of(context) : null;

    var resolvedTheme = variantConfigTheme ?? inheritedTheme ?? globalConfigTheme ?? ThemeData.fallback();
...
class _LocalizationWrapper extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final widgetsLocalizations = Localizations.of<WidgetsLocalizations>(context, WidgetsLocalizations);
    ...
    final delegates = [
      ...
      if (cupertinoLocalizations == null) DefaultCupertinoLocalizations.delegate,
    ];
